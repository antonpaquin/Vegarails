...
def plexform(name, ep, season)
  '/Media/Anime/' + name + '/Season ' + season.to_s.rjust(2,'0') + '/' + name + ' - s' + season.to_s.rjust(2,'0') + 'e' + ep.to_s.rjust(2,'0') + '.mkv'
end
anime_episodes = [
#  Name                                Anime_id   Length   Season   Episode  Watched  File
  ['Time for Bear and Girl to Part',   1,         '25:00', 1,       1,       true,    plexform('Kuma Miko', 1, 1)    ],
  ['A Hard Road',                      1,         '25:00', 1,       2,       false,   plexform('Kuma Miko', 2, 1)    ],
